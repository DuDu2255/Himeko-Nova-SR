...
fn ensureDefaultMail(uid: u32) void {
    ...
    mb.mails.append(.{
        ...
        .sender = "March 7th",
        .title = "Readme",
        .content = "CastoricePS is a free and open-source sofware\nJoin Discord.gg/CastoricePS for more info.\nThis server based on YaoGuangSR, write by HuLiNap They are Reversed Rooms. If you want know the orginal developer, please visit discord.gg/reversedrooms\n\nEnjoy the game!",
        .time = now,
