...
pub fn main() !void {
    ...
    // SRTools ("RobinSR" provider) uploads here.
    router.post("/srtools", srtools.onSave, .{});
    router.options("/srtools", srtools.onPreflight, .{});
    router.get("/srtools-export", srtools.onExport, .{});
    router.all("/*", srtools.onUnmatched, .{});
